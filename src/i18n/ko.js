...
module.exports = {
  ...
  // Copy All / Copy Mode (v2.6.9 — JSONL 기반)
  copyAll: '전체 대화 복사',
  copyMode: '복사 모드',
  copyModeHint: '드래그로 선택 · Ctrl+C로 복사 · Esc로 종료',
  copyModeExit: '종료',
  copiedAll: '전체 대화 복사됨',
  copiedAllFail: '복사 실패',
  copyModeNoTranscript: 'Claude 대화 기록 없음 — 터미널 화면을 표시합니다.',
  copyModeLoadedJsonl: '대화 기록 불러옴 · {0}턴',
  copySelection: '선택 복사',
  copiedSelection: '선택 복사됨',
  ...
  // v2.6.12: Podium-ready 세션 + 리더 주입
  podiumReady: 'Podium-ready',
  podiumReadyDesc: 'Claude를 tmux/psmux 세션 안에서 실행하여 omc team의 리더 페인으로 사용합니다.',
  podiumReadyBadge: 'Podium-ready · 팀 호스트 가능',
  leaderInjectPlaceholder: '리더에게 메시지 전송… (Enter: 전송 · Shift+Enter: 줄바꿈)',
  leaderInjectSend: '보내기',
  leaderInjectNotAvailable: '리더 주입 불가 — 팀에 tmux 세션이 없습니다.',
  leaderInjectSent: '전송됨 · 리더 페인이 tmux send-keys로 수신',
  leaderInjectFailed: '리더에게 메시지 전송 실패',
  leaderSourceCurrentSession: '현재 세션',
  leaderSourceNewTerminal: '새 터미널 (기본)',
};
